<?php
	...
	$mysqli->query($sql_tabla_mesa_1_respaldo);
	...
	$mysqli->query($sql_tabla_mesa_2_respaldo);
	...
	$mysqli->query($sql_tabla_mesa_3_respaldo);
	...
	$mysqli->query($sql_tabla_comandas);
	...
	$mysqli->query($sql_tabla_inventario);
	...
	$tabla_usuarios = $mysqli->query($sql_tabla_usuarios);

	if($tabla_usuarios){

		/*INSERCCION DE USUARIOS*/

		$sql_rol_admin = "INSERT INTO users(nombre, apellidos, correo, contraseña, rol)VALUES(
		'DIEGO', 'LOPEZ GARCIA', 'diego@admin.com', 'adminadmin', 'ADMINISTRADOR'
		)";

		$resultado = $mysqli->query($sql_rol_admin);

		$sql_rol_cocinero = "INSERT INTO users(nombre, apellidos, correo, contraseña, rol)VALUES(
		...
		$sql_rol_mesero = "INSERT INTO users(nombre, apellidos, correo, contraseña, rol)VALUES(
		'OCTAVIO', 'MUÑOZ GARCIA', 'octa@correo.com', '123456', 'MESERO'
		)";
		
		$resultado2 = $mysqli->query($sql_rol_mesero);

		echo 'EXITOSO INSERCCION DE REGISTROS';
