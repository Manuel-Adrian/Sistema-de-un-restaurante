<?php
	...
	if($opt=="SOPA DE PASTA"){
		...
		$sql = "INSERT INTO mesa1(categoria, opt, precio, fecha_entrada, cantidad, mesa, status, subtotal)
		VALUES('$categoria', '$opt', '$precio', '$fecha_entrada', '$cantidad', '$mesa', '$status', '$subtotal')";
		$resultado = $mysqli->query($sql);

		$sql2 = "INSERT INTO mesa1_respaldo(categoria, opt, precio, fecha_entrada, cantidad, mesa, status, subtotal)
		VALUES('$categoria', '$opt', $precio, '$fecha_entrada', '$cantidad', '$mesa', '$status', '$subtotal')";
